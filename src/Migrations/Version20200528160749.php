 ...
 */
final class Version20200528160749 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tenant ADD person_in_army_id INT DEFAULT NULL, CHANGE apartment_id apartment_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_4E59C46265DA34D6 ON tenant (person_in_army_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_4E59C46265DA34D6 ON tenant');
        $this->addSql('ALTER TABLE tenant DROP person_in_army_id, CHANGE apartment_id apartment_id INT DEFAULT NULL');
