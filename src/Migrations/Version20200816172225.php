 ...
 */
final class Version20200816172225 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE military_ranking (id INT AUTO_INCREMENT NOT NULL, rank_in_greek VARCHAR(15) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE military_residence (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, location VARCHAR(100) NOT NULL, address VARCHAR(100) NOT NULL, floors SMALLINT NOT NULL, number_of_apartments SMALLINT NOT NULL, INDEX IDX_B8ECA36C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE military_residence_type (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(10) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE person_in_army (id INT AUTO_INCREMENT NOT NULL, tenant_id INT DEFAULT NULL, unit_id INT DEFAULT NULL, scoring_id INT DEFAULT NULL, rank_id INT DEFAULT NULL, firstname VARCHAR(20) NOT NULL, surname VARCHAR(20) NOT NULL, specialty VARCHAR(10) NOT NULL, last_housing_date DATE DEFAULT NULL, UNIQUE INDEX UNIQ_404A3DB9033212A (tenant_id), INDEX IDX_404A3DBF8BD700D (unit_id), UNIQUE INDEX UNIQ_404A3DBDF2EDCBF (scoring_id), INDEX IDX_404A3DB7616678F (rank_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE scoring (id INT AUTO_INCREMENT NOT NULL, person_in_army_id INT DEFAULT NULL, is_married TINYINT(1) NOT NULL, has_num_of_children SMALLINT NOT NULL, has_relative_with_disability TINYINT(1) NOT NULL, months_waiting SMALLINT NOT NULL, months_housed SMALLINT NOT NULL, months_abroad SMALLINT NOT NULL, income VARCHAR(255) NOT NULL, exception_code SMALLINT DEFAULT NULL, general_score SMALLINT NOT NULL, positive_score SMALLINT NOT NULL, negative_score SMALLINT NOT NULL, wishes_to_be_housed TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_7B76A2CA65DA34D6 (person_in_army_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE military_residence ADD CONSTRAINT FK_B8ECA36C54C8C93 FOREIGN KEY (type_id) REFERENCES military_residence_type (id)');
        ...
        $this->addSql('ALTER TABLE person_in_army ADD CONSTRAINT FK_404A3DB7616678F FOREIGN KEY (rank_id) REFERENCES military_ranking (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE person_in_army DROP FOREIGN KEY FK_404A3DB7616678F');
        $this->addSql('ALTER TABLE apartment DROP FOREIGN KEY FK_4D7E68547DB2CDFA');
        $this->addSql('ALTER TABLE military_residence DROP FOREIGN KEY FK_B8ECA36C54C8C93');
        ...
        $this->addSql('DROP TABLE military_ranking');
        $this->addSql('DROP TABLE military_residence');
        $this->addSql('DROP TABLE military_residence_type');
