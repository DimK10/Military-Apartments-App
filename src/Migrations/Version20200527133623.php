 ...
 */
final class Version20200527133623 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tenant (id INT AUTO_INCREMENT NOT NULL, apartment_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_4E59C462176DFE85 (apartment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE person_in_army (id INT AUTO_INCREMENT NOT NULL, tenant_id INT DEFAULT NULL, unit_id INT DEFAULT NULL, scoring_id INT DEFAULT NULL, firstname VARCHAR(20) NOT NULL, surname VARCHAR(20) NOT NULL, rank VARCHAR(10) NOT NULL, specialty VARCHAR(10) NOT NULL, UNIQUE INDEX UNIQ_404A3DB9033212A (tenant_id), INDEX IDX_404A3DBF8BD700D (unit_id), UNIQUE INDEX UNIQ_404A3DBDF2EDCBF (scoring_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
