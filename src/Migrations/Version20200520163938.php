 ...
 */
final class Version20200520163938 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tenant (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, apartment_id INT DEFAULT NULL, score INT NOT NULL, UNIQUE INDEX UNIQ_4E59C462A76ED395 (user_id), UNIQUE INDEX UNIQ_4E59C462176DFE85 (apartment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
